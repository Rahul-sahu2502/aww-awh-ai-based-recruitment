                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 feature-section">
                                    ...
                                    <div class="modal fade" id="documentModal" tabindex="-1"
                                        aria-labelledby="documentModalLabel" aria-hidden="true" data-bs-backdrop="static">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.querySelectorAll(".myImg").forEach(function(link) {
                link.addEventListener("click", function() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('transition.entry') }}", // Laravel route function ka use karein
                        data: {
                            _token: "{{ csrf_token() }}", // CSRF token sahi tarike se bhejna
                            doc_name: doc_name, // Agar aap count store karna chahte hain
                            tbl_user_detail: @json($applicant_details)
                        },
                        success: function(response) {
                            console.log("Entry stored successfully!", response);
                        },
