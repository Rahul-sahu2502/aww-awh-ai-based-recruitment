                        ...
                        <form id="myForm1" action="{{ url('/candidate/save-post') }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <div class="col-md-12">
                                        <button style="float: right;" class="btn btn-primary nextBtn pull-right mt-5"
                ...
                <div class="card" id="tab2" style="display: none;">
                    <div class="row container"><br>
                        <form id="myForm2" action="{{ url('/candidate/save-applicant-detail') }}" method="post"
                            ...
                            <input type="hidden" name="Post_ID" id="HiddenPost_ID2">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-xs-12 text-left"><br>
                                    <label for="fname">आवेदनकर्ता का प्रथम नाम/First Name</label><label
                                        style="color:red">*</label>
                                    <!-- value="{{ isset($data['applicant_details']) ? $data['applicant_details']->First_Name : '' }}" -->
                                    <input type="text" value="{{ $firstName }}" id="fname"
                                        class="form-control" name="First_Name"
                                        placeholder="आवेदनकर्ता का प्रथम नाम दर्ज करें">
                                    <div id="error" class="invalid-feedback">
                                        This field is required<br>
                                    </div>
                                </div>
                                <div class="col-md-4 col-xs-12 text-left"><br>
                                    ...
                                    <!-- value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Middle_Name : '' }}" -->
                                    <input type="text" value="{{ $middleName }}" id="mname"
                                        class="form-control" name="Middle_Name"
                                        placeholder="आवेदनकर्ता का मध्य नाम दर्ज करें">
                                </div>
                                <div class="col-md-4 col-xs-12 text-left"><br>
                                    <label for="lname">अंतिम नाम/Last Name</label>
                                    <!-- value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Last_Name : '' }}" -->
                                    <input type="text" value="{{ $lastName }}" id="lname"
                                        class="form-control" name="Last_Name"
                                        placeholder="आवेदनकर्ता का अंतिम नाम दर्ज करें">
                                </div>
                            </div><br>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-xs-12 text-left">
                                    ...
                                    <textarea rows="5" id="caddr" class="form-control" name="corr_addr" style="resize: none;"
                                        placeholder="वर्तमान पता दर्ज करें">{{ isset($data['applicant_details']) ? $data['applicant_details']->Corr_Address : '' }}</textarea>
                                    <div id="error" class="invalid-feedback">
                                        This field is required<br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-xs-12 text-left">
                                    <label for="pincode">वर्तमान पिन कोड/Current Pincode</label><label
                                        style="color:red">*</label>
                                    <input type="number"
                                        value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Corr_pincode : '' }}"
                                        class="form-control" id="cpincode" name="pincode" maxlength="6"
                                        oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                        placeholder="वर्तमान पिन कोड दर्ज करें">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-xs-12 text-left">
                                    ...
                                    <input type="number"
                                        value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Perm_pincode : '' }}"
                                        class="form-control" id="ppincode" name="ppincode" maxlength="6"
                                        oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                        placeholder="स्थायी पिन कोड दर्ज करें">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-xs-12 text-left">
                                    <label for="dob">जन्मतिथि/Date of Birth </label><label
                                        style="color:red">*</label>
                                    <!-- <input type="date" value="{{ isset($data['applicant_details']) ? $data['applicant_details']->DOB : '' }}" id="dob" class="form-control" name="dob" max="{{ $data['maxdate'] }}"> -->
                                ...
                                <div class="col-md-3 col-xs-12 text-left">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="ई-मेल आई.डी. दर्ज करें">
                            ...
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-3">
                                    ...
                                    <select id="gender" class="form-select" name="gender">
                                        <option selected disabled value="undefined">-- चयन करें --</option>
                                        <option value="male"
                                            {{ isset($data['applicant_details']) && $data['applicant_details']->Gender == 'male' ? 'selected' : '' }}>
                                            पुरुष (Male)
                                        </option>
                                        <option value="female"
                                            {{ isset($data['applicant_details']) && $data['applicant_details']->Gender == 'female' ? 'selected' : '' }}>
                                            महिला (Female)
                                        </option>
                                        <option value="other"
                                            {{ isset($data['applicant_details']) && $data['applicant_details']->Gender == 'other' ? 'selected' : '' }}>
                                            अन्य (Other)
                                        </option>
                                    </select>
                                    <div id="error" class="invalid-feedback">
                                ...
                                <div class="col-md-3  text-left">
                                    ...
                                    <select id="caste" class="form-select" name="caste">
                                        <option selected disabled value="undefined">-- चयन करें --</option>
                                        <option value="UR"
                                            {{ isset($data['applicant_details']) && $data['applicant_details']->Caste == 'UR' ? 'selected' : '' }}>
                                            UR</option>
                                        <option value="OBC"
                                            {{ isset($data['applicant_details']) && $data['applicant_details']->Caste == 'OBC' ? 'selected' : '' }}>
                                            OBC</option>
                                        <option value="SC"
                                            {{ isset($data['applicant_details']) && $data['applicant_details']->Caste == 'SC' ? 'selected' : '' }}>
                                            SC</option>
                                        <option value="ST"
                                            {{ isset($data['applicant_details']) && $data['applicant_details']->Caste == 'ST' ? 'selected' : '' }}>
                                            ST</option>
                                    </select>
                                    <div id="error" class="invalid-feedback">
                                        This field is required<br>
                                ...
                                <div class="col-md-3 col-xs-12 text-left">
                                    <label for="mobile">आधार नंबर/AADHAR Number</label><label
                                        style="color:red">*</label>
                                    <input type="text"
                                        value="{{ isset($data['applicant_details']) ? $data['applicant_details']->aadharno : '' }}"
                                        class="form-control" id="adhaar" name="adhaar" maxlength="12"
                                        oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                        placeholder="आधार नंबर दर्ज करें">
                                    <div id="adhaar-error" class="invalid-feedback">The adhaar field must be 12 digits.
                                    </div>
                                </div>
                                <div class="col-md-3 col-xs-12 text-left">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="इपिक नंबर दर्ज करें">
                                    <div id="error" class="invalid-feedback">
                                        This field is required<br>
                                    </div>
                                </div>
                ...
                <div class="card" id="tab3" style="display: none;">
                    <div class="row"><br>
                        <form id="myForm3" action="{{ url('/candidate/save-education-detail') }}" method="post"
                            ...
                            <input type="hidden" name="Post_min_Quali" id="Post_min_Quali" />
                                    ...
                                    <table class="table table-responsive table-bordered" id="educationTable">
                                        ...
                                        <tr id="ssc">
                                            ...
                                            <td><select name="year_passing_ssc" class="form-select year_passing_ssc">
                                                    <option selected disabled value="undefined">-- चयन करें --</option>
                                                    <?php
                                                for ($i = $data['minyear']; $i <= $data['maxyear']; $i++) {
                                                ?>
                                                    <option value="<?= $i ?>"
                                                        {{ !empty($data['applicant_details']) && $data['applicant_details']->Year_Passing_SSC == $i ? 'selected' : '' }}>
                                                        <?= $i ?></option>
                                                    <?php
                                                }
                                                ?>
                                            ...
                                            <td><input type="number"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Marks_Obtained_10th : '' }}"
                                            ...
                                            <td><input type="number"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Marks_Total_10th : '' }}"
                                            ...
                                            <td><input type="text"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Perc_SSC : '' }}"
                                            ...
                                            <td><input type="text"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->School_Board_Name_10th : '' }}"
                                        ...
                                        <tr id="inter" class="educationRow">
                                                    ...
                                                    @foreach ($subjects as $subject)
                                                        @if ($subject->fk_Quali_ID == 2)
                                                            <option value="{{ $subject->subject_code }}"
                                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->Inter_Subject == $subject->subject_code ? 'selected' : '' }}>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                    <option value="<?= $i ?>"
                                                        {{ !empty($data['applicant_details']) && $data['applicant_details']->Year_Passing_Inter == $i ? 'selected' : '' }}>
                                                        <?= $i ?></option>
                                                    <?php
                                                }
                                                ?>
                                            ...
                                            <td><input type="number"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Marks_Obtained_12th : '' }}"
                                            ...
                                            <td><input type="number"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Marks_Total_12th : '' }}"
                                            ...
                                            <td><input type="text"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Perc_Inter : '' }}"
                                            ...
                                            <td><input type="text"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->School_Board_Name_12th : '' }}"
                                        ...
                                        <tr id="ug" class="educationRow">
                                                ...
                                                <select class="form-select ug_subject" name="ug_subject" id="ug">
                                                    ...
                                                    @foreach ($subjects as $subject)
                                                        @if ($subject->fk_Quali_ID == 3)
                                                            <option value="{{ $subject->subject_code }}"
                                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->UG_Subject == $subject->subject_code ? 'selected' : '' }}>
                                                                {{ $subject->subject_name }}
                                                            </option>
                                                        @endif
                                                    @endforeach
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                    <option value="<?= $i ?>"
                                                        {{ !empty($data['applicant_details']) && $data['applicant_details']->Year_Passing_UG == $i ? 'selected' : '' }}>
                                                        <?= $i ?></option>
                                                    <?php
                                                }
                                                ?>
                                            ...
                                            <td><input type="number"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Graduation_Obtained_Marks : '' }}"
                                            ...
                                            <td><input type="number"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Graduation_Total_Marks : '' }}"
                                            ...
                                            <td><input type="text"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Perc_UG : '' }}"
                                            ...
                                            <td><input type="text"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Graduation_University : '' }}"
                                        ...
                                        <tr id="pg" class="educationRow">
                                                ...
                                                <select class="form-select" name="pg_subject" id="pg_subject">
                                                    ...
                                                    @foreach ($subjects as $subject)
                                                        @if ($subject->fk_Quali_ID == 4)
                                                            <option value="{{ $subject->subject_code }}"
                                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->PG_Subject == $subject->subject_code ? 'selected' : '' }}>
                                                                {{ $subject->subject_name }}
                                                            </option>
                                                        @endif
                                                    @endforeach
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                    <option value="<?= $i ?>"
                                                        {{ !empty($data['applicant_details']) && $data['applicant_details']->Year_Passing_PG == $i ? 'selected' : '' }}>
                                                        <?= $i ?></option>
                                                    <?php
                                                }
                                                ?>
                                            ...
                                            <td><input type="number"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->PG_Obtained_Marks : '' }}"
                                            ...
                                            <td><input type="number"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->PG_Total_Marks : '' }}"
                                            ...
                                            <td><input type="text"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->Perc_PG : '' }}"
                                            ...
                                            <td><input type="text"
                                                    value="{{ isset($data['applicant_details']) ? $data['applicant_details']->PG_University : '' }}"
                        ...
                        <form id="myForm4" action="{{ url('/candidate/save-experience-detail') }}" method="post"
                            ...
                            <div class="col-md-12"><br>
                                ...
                                <div class="field_wrapper" id="inputFieldsContainer">
                                    @if (isset($data['applicant_details']) && $data['applicant_details']->experience_details)
                                        @foreach ($data['applicant_details']->experience_details as $index => $experience_details)
                                            <div class="row experience-row">
                                                <div class="row">
                                                    <div class="col-md-5 text-left">
                                                        <label for="orgname_{{ $index }}">संस्था का नाम व पूरा पता
                                                            <font color="red">*</font>
                                                        </label>
                                                        <input type="text"
                                                            value="{{ $experience_details->Organization_Name }}"
                                                            id="orgname_{{ $index }}" class="form-control"
                                                            name="org_name[]" placeholder="संस्था का नाम/पता दर्ज करें"
                                                            required>
                                                        <div id="error" class="invalid-feedback">This field is
                                                            required<br></div>
                                                    </div>
                                                    <div class="col-md-3 text-left">
                                                        <label for="orgtype_{{ $index }}">संस्था शासकीय है अथवा
                                                            अशासकीय<font color="red">*</font></label>
                                                        <select id="orgtype_{{ $index }}"
                                                            class="form-select org-type-select" name="org_type[]">
                                                            <option selected disabled value="undefined">-- चयन करें --
                                                            </option>
                                                            <option
                                                                {{ $experience_details->Organization_Type == 'Govt' ? 'selected' : '' }}
                                                                value="Govt">शासकीय</option>
                                                            <option
                                                                {{ $experience_details->Organization_Type == 'NGO' ? 'selected' : '' }}
                                                                value="NGO">अशासकीय(NGO)</option>
                                                            <option
                                                                {{ $experience_details->Organization_Type == 'SemiGovt' ? 'selected' : '' }}
                                                                value="SemiGovt">अर्धशासकीय</option>
                                                        </select>
                                                        <div id="error" class="invalid-feedback">This field is
                                                            required<br></div>
                                                    </div>
                                                    <div class="col-md-4 text-left ngo-field"
                                                        style="display: {{ $experience_details->Organization_Type == 'NGO' ? 'block' : 'none' }}">
                                                        <label for="ngono_{{ $index }}">यदि संस्था अशासकीय है तो
                                                            भारत शासन के NGO पोर्टल में पंजीयन क्र.</label>
                                                        <input value="{{ $experience_details->NGO_No }}" type="text"
                                                            id="ngono_{{ $index }}" class="form-control"
                                                            name="ngo_no[]"
                                                            placeholder="NGO पोर्टल में पंजीयन क्र दर्ज करें">
                                                    </div>
                                                    <!-- Rest of your fields remain same -->
                                                    <div class="col-md-3 text-left">
                                                        <label for="desgname_{{ $index }}">पदनाम</label><label
                                                            style="color:red">*</label>
                                                        <input value="{{ $experience_details->Designation }}"
                                                            type="text" id="desgname_{{ $index }}"
                                                            class="form-control" name="desg_name[]"
                                                    ...
                                                    <div class="col-md-3 text-left">
                                                        <label for="nature">अनुभव का कार्यक्षेत्र</label><label
                                                            style="color:red">*</label>
                                                        <input value="{{ $experience_details->Nature_Of_Work }}"
                                                    ...
                                                    <div class="col-md-3 text-left">
                                                        <label for="dfrom">कब से</label><label
                                                            style="color:red">*</label>
                                                        <input value="{{ $experience_details->Date_From }}"
                                                            type="date" id="dfrom" class="form-control"
                                                    ...
                                                    <div class="col-md-3 text-left">
                                                        <label for="dto">कब तक</label><label
                                                            style="color:red">*</label>
                                                        <input value="{{ $experience_details->Date_To }}" type="date"
                                                            id="dto" class="form-control" name="date_to[]"
                                                            max="{{ $data['maxdate'] }}">
                                                        <div id="error" class="invalid-feedback">
                                                            This field is required<br>
                                                        </div>
                                    ...
                                    @else
                                        <div class="row experience-row">
                                            <div class="row">
                                                <div class="col-md-5 text-left">
                                                    <label for="orgname_0">संस्था का नाम व पूरा पता<font color="red">*
                                                        </font></label>
                                                    <input type="text" id="orgname_0" class="form-control"
                                                        name="org_name[]" placeholder="संस्था का नाम/पता दर्ज करें">
                                                    <div id="error" class="invalid-feedback">This field is
                                                        required<br></div>
                                                </div>
                                                <div class="col-md-3 text-left">
                                                    <label for="orgtype_0">संस्था शासकीय है अथवा अशासकीय<font
                                ...
                                {{-- <div class="row">
                                    <div class="col-md-12 col-xs-12 text-left">
                                        ...
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 30px;">
                                            <input type="radio"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->Marital_Status == 'married' ? 'checked' : '' }}
                                                id="marital" name="marital" value="married"> Married
                                        </label>
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 20px;">
                                            <input type="radio"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->Marital_Status == 'unmarried' ? 'checked' : '' }}
                                                id="marital" name="marital" value="unmarried"> UnMarried
                                        </label>
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 20px;">
                                            <input type="radio"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->Marital_Status == 'divorced' ? 'checked' : '' }}
                                                id="marital" name="marital" value="divorced"> Divorced
                                        </label>
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 20px;">
                                            <input type="radio"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->Marital_Status == 'widow' ? 'checked' : '' }}
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xs-12 text-left">
                                        ...
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 30px;">
                                            <input class="pntr"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->domicile == 'Yes' ? 'checked' : '' }}
                                                type="radio" id="prof" name="domicile" value="Yes"
                                                class="pntr @error('domicile') is-invalid @enderror">&nbsp;Yes
                                        </label>
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 20px;">
                                            <input class="pntr"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->domicile == 'No' ? 'checked' : '' }}
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xs-12 text-left">
                                        ...
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 30px;">
                                            <input type="radio"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->girlchild == 'Yes' ? 'checked' : '' }}
                                                id="girlchild" name="girlchild" value="Yes">&nbsp;Yes
                                        </label>
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 20px;">
                                            <input type="radio"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->girlchild == 'No' ? 'checked' : '' }}
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xs-12 text-left">
                                        ...
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 30px;">
                                            <input type="radio"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->belowpl == 'Yes' ? 'checked' : '' }}
                                                id="below_pl" name="below_pl" value="Yes">&nbsp;Yes
                                        </label>
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 20px;">
                                            <input type="radio"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->belowpl == 'No' ? 'checked' : '' }}
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xs-12 text-left">
                                        ...
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 30px;">
                                            <input type="radio"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->ecci == 'Yes' ? 'checked' : '' }}
                                                id="ecci" name="ecci" value="Yes">&nbsp;Yes
                                        </label>
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 20px;">
                                            <input type="radio"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->ecci == 'No' ? 'checked' : '' }}
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xs-12 text-left">
                                        ...
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 30px;">
                                            <input type="radio"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->ncc == 'Yes' ? 'checked' : '' }}
                                                id="ncc" name="ncc" value="Yes">&nbsp;Yes
                                        </label>
                                        <label class="radio-inline" style="margin-top: -10px; margin-left: 20px;">
                                            <input type="radio"
                                                {{ !empty($data['applicant_details']) && $data['applicant_details']->ncc == 'No' ? 'checked' : '' }}
                            ...
                            <div class="col-md-12"><br>
                                <div class="field_wrapper" id="inputFieldsContainer">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-xs-12 text-left">
                                            <label for="sign">10th प्रमाण पत्र अपलोड करें / Upload 10th Marksheet
                                                <font color="red">*</font>
                                            </label>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // $('#dfrom').load(function() {
            //     alert(0);
            var issuedDateValue = $('#dfrom').val();
            if (issuedDateValue) {
                var issuedDate = new Date(issuedDateValue);
                issuedDate.setDate(issuedDate.getDate() + 1); // Increment the date by one day
                var formattedDate = issuedDate.toISOString().split('T')[
                    0]; // Format the date to YYYY-MM-DD
                document.getElementById('dto').setAttribute('min', formattedDate);
            }
            // });
            ...
            $('form input').keyup(function() {
                if (this.value) {
                    ...
                    if (elementName != "Middle_Name" && elementName != "Last_Name" && elementName !=
                        "email" && elementName != "perc_ssc" && elementName != "perc_inter" &&
                        elementName != "perc_pg" && elementName != "perc_ug" && elementName !=
                        "pond_name" && elementName != "khasra_no" && elementName != "rakba" &&
                        elementName != "amount")
                        if (element.length) {
                            // Remove the is-invalid class from input elements
            ...
            function toggleNgoField($selectElement) {
                ...
                if ($selectElement.val() === 'NGO') {
                    $ngoField.show();
                } else {
                    $ngoField.hide();
                    // Optional: Clear the input when hidden
                    $ngoField.find('input').val('');
                }
            }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.status == 'success') {
                            ...
                            document.getElementById("HiddenPost_ID2").value = data.Post_ID;
            ...
            /// Only Required Education Field Show Functionality
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.status == 'success') {
                            ...
                            document.getElementById("Post_min_Quali").value = data
                                .Post_min_Quali;
                            document.getElementById("Post_min_Quali2").value = data
                                .Post_min_Quali;
                            $Post_min_Qualification = data.Post_min_Quali;

                            // Check Post_id and its min Qualification then according that Show 10th ,12th, UG and PG 
        ...
        $('#addmoreBtn').click(function() {
            var newInputFields = '<div class="input-fields"><div class="row">' +
                ...
                '<label for="orgname_0">संस्था का नाम व पूरा पता<font color="red">*</font></label>' +
                '<input type="text" id="orgname_0" class="form-control" name="org_name[]" placeholder="" required>' +
                '</div>' +
                '<div class="col-md-3 text-left"><br>' +
                '<label for="orgtype_0">संस्था शासकीय है अथवा अशासकीय<font color="red">*</font></label>' +
                '<select id="orgtype_0" class="form-select" name="org_type[]" required>' +
                '  <option selected disabled value="undefined">-- चयन करें --</option>' +
                '<option value="Govt">शासकीय</option>' +
                '<option value="NGO">अशासकीय(NGO)</option>' +
                '<option value="SemiGovt">अर्धशासकीय</option>' +
                ...
                '</div>' +
                '<div class="col-md-3 text-left"><br>' +
                '<label for="ngono_0">यदि संस्था अशासकीय है तो भारत शासन के NGO पोर्टल में पंजीयन क्र.</label>' +
                '<input type="text" id="ngono_0" class="form-control" name="ngo_no[]" placeholder="">' +
                '</div>' +
                '<div class="col-md-3 text-left">' +
                '<label for="desgname">पदनाम</label><label style="color:red">*</label>' +
