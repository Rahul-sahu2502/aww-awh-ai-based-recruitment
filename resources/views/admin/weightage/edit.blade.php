        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('static-posts.list') }}">वेटेज मार्क्स की सूची</a></li>
            ...
            <div class="col-lg-12 col-md-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.weightage.update', $post->post_id) }}" method="post"
                            id="weightageForm">
                            @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#weightageForm').on('submit', function(e) {
                ...
                if (!hasValues) {
                    alert('कृपया कम से कम एक प्रश्न के लिए वेटेज मार्क्स दर्ज करें।');
                    e.preventDefault();
                    return false;
                }
