    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="row gx-3 gy-3">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="fw-bold text-light mb-0"
                                                    style="font-size: 1.4rem; color: #ffffff;">
                                    ...
                                    <a href="{{ url('/admin/verified-list') }}" class="text-decoration-none text-dark">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="fw-bold text-light mb-0" style="font-size: 1.4rem;">
                                                    {{ $data['total_verified_Applications'] }}
                                                </h3>
                                            </div>
                                    ...
                                    <a href="{{ url('/admin/rejected-list') }}" class="text-decoration-none text-dark">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h3 class="fw-bold text-light mb-0" style="font-size: 1.4rem;">
                                                    {{ $data['total_rejected_Applications'] }}
                                                </h3>
                                            </div>
                                ...
                                <div class="card-body px-3 py-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <h3 class="fw-bold text-light mb-0" style="font-size: 1.4rem;">
                                                {{ $data['total_Pending_Applications'] }}
                                            </h3>
                                        </div>
                ...
                </div><!-- End col-lg-9 (Left side) -->
            </div><!-- End col-lg-3 (Right side) -->

            <!-- Charts Row -->
            <div class="row mt-2">
                <div class="col-lg-8 d-flex">
                    <div class="card shadow-sm rounded-4 p-4 w-100"
                        style="background: linear-gradient(135deg, #dff4ec, #ffffff); border-radius: 1.2rem;">
                        <h6 class="text-dark fw-bold mb-3 text-start">श्रेणी अनुसार आवेदन</h6>
                ...
                <div class="col-lg-4 d-flex">
                    <div class="card shadow-sm rounded-4 p-4 w-100"
                        style="background: linear-gradient(135deg, #f0f7fd, #ffffff); border-radius: 1.2rem;">
                        <h6 class="text-dark fw-bold mb-3 text-start">श्रेणी के अनुसार आवेदन</h6>
                        <div id="application-overview" style="min-height: 250px"
                            data-vals='@json([$data['pending_count'], $data['verified_count'], $data['rejected_count']])'>
                        </div>
                    </div>
                </div>
            </div>

            <!-- District wise chart if condition -->
            @if (Session::get('sess_role') === 'Super_dmin' && !Session::get('district_id'))
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <div class="card shadow-sm rounded-4 p-4" style="min-height: 150px; border-radius: 1.2rem;">
                            <h6 class="text-left mb-4 fw-bold">जिलावार आवेदन गणना </h6>
                            <div id="dist_wise-application-overview" dist-application-name='@json(collect($data['dist_applications'])->pluck('name'))'
                                dist-application-count='@json(collect($data['dist_applications'])->pluck('total_applications'))'>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <script>
                    // Your existing district chart script here...
                </script>
            @endif
            ...
            <div class="row mt-2">
                <div class="col-lg-8 d-flex">
                    <div class="card shadow-sm rounded-4 p-4 w-100"
                        ...
                        <div id="qualification-overview" data-quali-id='@json(collect($data['qualiChartData'])->pluck('fk_Quali_ID'))'
            ...
            @php
                $advertisementData = session('sess_role');
                $district_id = session('district_id');
            @endphp
            @if ($advertisementData === 'Admin' || ($advertisementData === 'Super_admin' && $district_id != 0))
                <div class="row mt-4">
                    <div class="col-lg-12">
...
@section('scripts')
    ...
    <script>
            ...
            loadDataBtn.addEventListener('click', function() {
                ...
                fetch("{{ route('load.api.data') }}", {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            alert('✅ प्रक्रिया सफलतापूर्वक पूर्ण हो गई!');
                        } else {
                            alert('⚠️ प्रक्रिया विफल रही। कृपया पुनः प्रयास करें।');
                        }
                    })
                    .catch(err => {
                        // Hide loader, show text, enable button
        ...
        document.addEventListener("DOMContentLoaded", function() {
            // Pie Chart - Application Overview
            ...
            // Ensure all 3 categories are present (fill missing with 0)
            ...
            var countOptions = {
                ...
                chart: {
                    ...
                    events: {
                        dataPointSelection: function(event, chartContext, config) {
                            ...
                            const routes = [
                                "{{ url('/admin/application-list') }}", // लंबित आवेदन
                                "{{ url('/admin/verified-list') }}", // पात्र  आवेदन
                                "{{ url('/admin/rejected-list') }}" // अपात्र  आवेदन
                            ];
                ...
                dataLabels: {
                    ...
                    style: {
                        fontSize: '14px',
                        fontWeight: 'bold' // ← yahan bold hoga
                    }
                },
                plotOptions: {
                    pie: {
            ...
            var applicationCountChart = new ApexCharts(applicationChartElement, countOptions);
            applicationCountChart.render();

            // Bar Chart - Category Overview
            var categoryNames = @json(collect($category_count)->pluck('caste_title'));
            var categoryCounts = @json(collect($category_count)->pluck('total'));

            var truncatedCategoryNames = categoryNames.map(name => {
            ...
            var categoryOptions = {
                chart: {
                    ...
                    events: {
                        dataPointSelection: function(event, chartContext, config) {
                            let selectedCategory = categoryNames[config.dataPointIndex];
                            if (selectedCategory) {
                                loadInlineCategoryChart(selectedCategory);
                ...
                series: [{
                    name: 'आवेदन संख्या',
                    data: categoryCounts.map((count, index) => ({
                        x: truncatedCategoryNames[index],
                        y: count,
                        fillColor: ['#26A69A', '#66BB6A', '#FF7043', '#42A5F5', '#AB47BC',
                            '#EC407A', '#FFCA28'
                        ][index % 7]
                    }))
                }],
                colors: ['#26A69A', '#66BB6A', '#FF7043', '#42A5F5', '#AB47BC', '#EC407A', '#FFCA28'],
                plotOptions: {
                    bar: {
                        distributed: true,
                        horizontal: true,
                ...
                yaxis: {
                    categories: truncatedCategoryNames,
                    labels: {
                        show: false,
                        style: {
                            fontSize: '11px',
                ...
                tooltip: {
                    ...
                    custom: function({
                        ...
                        return `
                                                                    <div style="padding: 8px 12px; background: rgba(0,0,0,0.8); color: white; border-radius: 4px; font-size: 12px;">
                                                                        <div><strong>${categoryNames[dataPointIndex]}</strong></div>
                                                                        <div>${series[seriesIndex][dataPointIndex]} आवेदन</div>
                                                                    </div>
                                                                `;
                    }
                },
                legend: {
                    ...
                    markers: {
                        ...
                        strokeWidth: 0,
                        strokeColor: '#fff',
                        fillColors: ['#26A69A', '#66BB6A', '#FF7043', '#42A5F5', '#AB47BC', '#EC407A',
                            '#FFCA28'
                        ],
                    },
                    itemMargin: {
                    ...
                    formatter: function(seriesName, opts) {
                        return truncatedCategoryNames[opts.seriesIndex] || seriesName;
                    },
                    labels: {
                        colors: ['#374151'],
                ...
                grid: {
                    ...
                    padding: {
                        top: 10,
                        right: 20,
                        bottom: 5, // Extra space for legend
                        left: 10
                    }
                }
            };
            ...
            // Load first valid category data initially
            for (let i = 0; i < categoryCounts.length; i++) {
                if (categoryCounts[i] > 0) {
                    loadInlineCategoryChart(categoryNames[i]);
                    updateCategoryName(categoryNames[i]);
                    break;
                }
            }

            // Load radial chart for sub-category detail
            function loadInlineCategoryChart(casteTitle) {
                $.ajax({
                    url: "{{ route('category.detail.data') }}",
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        caste: casteTitle
                    ...
                    success: function(res) {
                        if (window.detailRadialChart) {
                            window.detailRadialChart.destroy();
                        }

                        if (res.values.length === 0) {
                            $('#category-detail-overview').html(
                                "<p class='text-center text-muted'>कोई डेटा नहीं मिला</p>");
                            return;
                        }
                                ...
                                radialBar: {
                                    dataLabels: {
                                        ...
                                        total: {
                                            ...
                                            label: 'कुल',
                                            formatter: function() {
                                                return res.values.reduce((a, b) => a + b, 0);
                                            }
                                        }
                                    }
                                }
                        ...
                        window.detailRadialChart = new ApexCharts(document.querySelector(
                            "#category-detail-overview"), radialOptions);
                        window.detailRadialChart.render();
                    }
                });
            }

            function updateCategoryName(casteTitle) {
                $('#selected-category-name').text(casteTitle + ' श्रेणी के आवेदन');
            }
        });
                                                                        ...
                                                                        <table class="table table-sm table-bordered table-hover mb-0">
                                                                            ...
                                                                            <tbody>
                                                                                ${posts.map((post, index) => `
                                                                                                                                                            <tr>
                                                                                                                                                                <td class="text-center">${index + 1}</td>
                                                                                                                                                                <td><strong>${post.post_name}</strong></td>
        ...
        function exportToPDF() {
            ...
            doc.save(`विज्ञापन_विवरण_${new Date().toISOString().split('T')[0]}.pdf`);
        }
    </script>
